...
= 1.3.1 =
New: 'hmsclassic' message bug fixed. 'Password request for every page' bug fixed. Password characters hidden on front end. Select a notification message for your login page. Premium users - Set background image size, position, repeat, and color. Customize notification message.